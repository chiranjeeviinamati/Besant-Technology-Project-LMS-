            ...
            <form className='w-[90%] md:w-200 h-150 bg-[white] shadow-xl rounded-2xl flex' onSubmit={(e)=>e.preventDefault()}>
                <div className='md:w-[50%] w-[100%] h-[100%] flex flex-col items-center justify-center gap-4 '>
                    ...
                    <div className='flex flex-col gap-1 w-[85%] items-start justify-center px-3'>
                        ...
                        <input id='email' type="text" className='border-1 w-[100%] h-[35px] border-[#e7e6e6] text-[15px] px-[20px]' placeholder='Type any Question ' onChange={(e)=>setEmail(e.target.value)} value={email} />
                      <button aligain itemID=''>Submit</button>
                    </div>
